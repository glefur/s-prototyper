...
public class SPrototyperSemanticSequencer extends XbaseWithAnnotationsSemanticSequencer {
	...
	protected void sequence_JavaServiceClassReference(EObject context, JavaServiceClassReference semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getJavaServiceClassReferenceAccess().getJavaClassJvmTypeReferenceParserRuleCall_1_0(), semanticObject.getJavaClass());
		feeder.finish();
	}
